...
function displayBanner(version, title = 'RAVDW') {
    const bannerText = chalk.greenBright.bold(figlet.textSync(title, {
        font: 'Standard',
        horizontalLayout: 'default',
    })) + '\n' + chalk.whiteBright(`${chalk.yellowBright('🌱 v'+version)}\n\n🔍 Consulta WHOIS simples.\n📬 Sugestões inteligentes de contatos para denúncia.\n📄 Sistema simples de relatório.`);
